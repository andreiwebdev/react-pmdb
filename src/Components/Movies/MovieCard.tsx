...
const MovieCard = (props: Props) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative flex items-start justify-between p-4 sm:p-6 lg:p-8 h-full">
        <div className="text-white md:pt-[80%] lg:pt-[100%]">
          <h3 className="text-xl font-bold sm:text-2xl">{props.title}</h3>
